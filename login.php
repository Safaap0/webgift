...
if (isset($_POST['submit'])) {
    ...
    $select = mysqli_query($conn, "SELECT * FROM `hack_table` WHERE email = '$email' AND pass = '$pass'") or die('query failed');
...
<head>
    ...
    <style>
        ...
        .footer {
            ...
            color: #7f8c8d;
            font-size: 0.9em;
            width: calc(100% - 4rem);  /* Adjusted for padding */
        }
...
<body>
    <div class="page-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="form-container">
                ...
                <div class="note-box">
                    <p>Note: For security purposes, please ensure your password is strong and not shared with others.</p>
                </div>
            </div>
        </div>
    ...
    <div class="footer">
        <img src="images/32.jpg" alt="Profile Pic">
        <p>&copy; 2024 Safaa Mazin Hammoodi. All Rights Reserved. | <a href="#">Privacy Policy</a></p>
    </div>
</body>
</html>
